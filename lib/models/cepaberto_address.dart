class CepAbertoAddress {
  ...
  // Transformando os dados em Map para ser acessando pelo Cep Aberto
  ...
  @override
  String toString() {
    return 'CepAbertoAddress{altitude: $altitude, cep: $cep, '
        'latitude: $latitude, longitude: $longitude, logradouro: $logradouro, '
